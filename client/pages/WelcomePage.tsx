      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Your AI-powered health companion for tracking vitals, mental
            wellness, and medical questions. Track. Prevent. Thrive.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/medbot/services">
              <Button
                variant="outline"
                className="border-purple-600 text-purple-600 hover:bg-purple-50 px-8 py-4 text-lg rounded-full"
              >
                Explore Features
              </Button>
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Monitor your vitals, blood pressure, heart rate, and other key
              health metrics with ease.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Track your mood, access mental health resources, and chat with our
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Stay active with personalized exercise routines and wellness
              tracking features.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Get instant answers to health questions and personalized
